...
const buildNavbar = () => {
  ...
  // domString += '      <a id="navToPortfolio" class="nav-item nav-link" href="#portfolioPage">Portfolio</a>';
  domString += '      <a id="navToProjects" class="nav-item nav-link" href="#projectsPage">Projects</a>';
  ...
  domString += '      <a id="navToFooter" class="nav-item nav-link" href="#contactPage">Contact</a>';
  domString += '    </div>';
  domString += '  </nav>';
  domString += '</div>';
