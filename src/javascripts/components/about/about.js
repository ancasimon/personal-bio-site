...
const buildAboutSection = () => {
  ...
  domString += '<hr></hr>';
  domString += '<div class="d-flex mx-auto" style="width: 1000px;">';
  ...
  domString += '</div>';
  domString += '<div class="d-flex m-3 mx-auto" style="width: 1300px;">';
  domString += '<div class="card p-3 m-1 border-dark bg-light col-md-4">';
  ...
  domString += '</div>';
  domString += '<div class="card p-1 m-1 border-dark bg-light col-md-4">';
